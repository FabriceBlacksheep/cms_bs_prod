...
CREATE TABLE `content_category` (
  ...
  CONSTRAINT `FK_54FBF32E12469DE2` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_54FBF32E84A0A3ED` FOREIGN KEY (`content_id`) REFERENCES `content` (`id`) ON DELETE CASCADE
...
INSERT INTO `content_category` VALUES (4,1),(4,4),(5,2),(5,3),(6,1),(7,2),(7,3);
