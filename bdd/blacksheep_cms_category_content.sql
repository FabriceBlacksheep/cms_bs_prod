...
CREATE TABLE `category_content` (
  ...
  KEY `IDX_391D70D784A0A3ED` (`content_id`),
  CONSTRAINT `FK_391D70D712469DE2` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_391D70D784A0A3ED` FOREIGN KEY (`content_id`) REFERENCES `content` (`id`) ON DELETE CASCADE
